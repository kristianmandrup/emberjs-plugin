 ...
 */
public class EmberJSParser extends JavaScriptParser<EmberJSParser.EmberJSExpressionParser, StatementParser, FunctionParser> {
    ...
    public void parseEmber(IElementType root) {
    ...
    protected class EmberJSExpressionParser extends ExpressionParser<EmberJSParser> {
        public EmberJSExpressionParser() {
            super(EmberJSParser.this);
        }
        ...
        private boolean parseAsExpression() {
            ...
            expr.done(EmberJSElementTypes.AS_EXPRESSION);
            return true;
        }
