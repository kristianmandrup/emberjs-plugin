 ...
 */
public abstract class EmberJSReferenceBase<T extends PsiElement> extends PsiReferenceBase<T> {
    public EmberJSReferenceBase(T element, TextRange textRange) {
    ...
    public boolean equals(Object o) {
        ...
        EmberJSReferenceBase that = (EmberJSReferenceBase)o;
    ...
    private static class MyResolver implements ResolveCache.Resolver {
        ...
        public PsiElement resolve(@NotNull PsiReference ref, boolean incompleteCode) {
            return ((EmberJSReferenceBase)ref).resolveInner();
        }
    }
}
