 ...
 */
public class EmberJSTagDescriptor implements XmlElementDescriptor {
    protected final String myName;
    private final JSNamedElementProxy myDeclaration;

    public EmberJSTagDescriptor(String name, JSNamedElementProxy declaration) {
        myName = name;
    ...
    public XmlAttributeDescriptor[] getAttributesDescriptors(@Nullable XmlTag context) {
        ...
        final XmlAttributeDescriptor[] commonAttributes = {
                RelaxedHtmlFromSchemaElementDescriptor.getAttributeDescriptorFromFacelets(string, context)
        };
